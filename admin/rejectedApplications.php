...
if (!isset($_SESSION['loggedIn'])) {
  ...
  $applications = "SELECT * FROM applications WHERE status = 'rejected'";
      ...
      <table class="table table-light">
        <thead class="thead-dark">
          <tr>
            ...
            <th class="font-12">Remove Application</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          ?>
              <tr>
                ...
                <td class="font-12 text-danger"><a href="deleteRjectedApplications.php?id=<?php echo $applications["id"] ?>" class="btn btn-danger font-12 ">Delete</a></td>
              </tr>
          <?php
            }
          } else {
